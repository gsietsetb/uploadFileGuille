 ...
 * Esta es una implementación simple para entornos donde crypto.randomUUID no está disponible
 * @returns Un UUID v4 generado aleatoriamente
 */
export const generateUUID = (): string => {
  // Implementación simplificada de UUID v4
